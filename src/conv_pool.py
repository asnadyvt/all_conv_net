...
def conv_pool_cnn_a():
    ...
    net['conv1_2'] = ConvLayer(net['conv1_1'], num_filters=96, filter_size=3, pad='same',  flip_filters=False)
    ...
    net['conv3_2'] = ConvLayer(net['conv3_1'], num_filters=192, filter_size=3, pad='same',  flip_filters=False)
...
def conv_pool_cnn_b():
    ...
    net['conv1_3'] = ConvLayer(net['conv1_2'], num_filters=96, filter_size=3, pad='same',  flip_filters=False)
    ...
    net['conv3_3'] = ConvLayer(net['conv3_2'], num_filters=192, filter_size=3, pad='same',  flip_filters=False)
